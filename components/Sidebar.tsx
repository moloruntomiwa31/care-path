  ...
  return (
    <>
      <button
        ...
        className={`lg:hidden fixed top-4 z-1000 bg-primary text-white p-2 rounded-lg shadow-lg w-10 h-10 flex items-center justify-center ${isOpen ? 'right-28' : 'left-4'}`}
      >
      ...
      >
        <div className="p-4 border-b border-gray-200">
          ...
          <div className="px-4 py-3 bg-gray-50 border-b border-gray-200">
            ...
            <p className="text-xs font-medium text-gray-700 truncate">{!locationName ? 'Searching...' : locationName}</p>
          </div>
